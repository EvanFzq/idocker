...
import { ContainerStatusName, ContainerStatusColor } from '@common/constants/enum';
...
const statusLabel = computed(
  () => containerDetail.value.status && ContainerStatusName[containerDetail.value.status],
);
const statusColor = computed(
  () => containerDetail.value.status && ContainerStatusColor[containerDetail.value.status],
);
...
const onClickEdit = () => {
  router.push({ path: '/m/container', query: { id: containerDetail.value.id } });
};
